...
module PqApiV2
  ...
  class Configuration < CoreLibrary::HttpClientConfiguration
    ...
    attr_reader :environment, :sandbox_instance, :uat_instance,
                :server_credentials, :clientside_credentials, :api_version
    ...
    def initialize(
      ...
      clientside_credentials: nil, api_version: '2026.02.01'
    )
    ...
    def self.build_default_config_from_env
      ...
      api_version = ENV.fetch('API_VERSION', '2026.02.01')

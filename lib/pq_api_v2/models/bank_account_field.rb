...
module PqApiV2
  ...
  # /instruments/requirements/search` for the (country, currency) combination of
  # the bank account.
  class BankAccountField < BaseModel
    ...
    # Value for the bank account field
    # @return [String]
    attr_accessor :value
    ...
    def self.from_hash(hash)
      ...
      BankAccountField.new(key: key,
                           value: value,
                           additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [BankAccountField | Hash] The value against the validation is performed.

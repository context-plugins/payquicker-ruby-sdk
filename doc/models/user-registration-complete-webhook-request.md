...
# User Registration Complete Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`UserRegistrationCompleteWebhookRequest`
...
```ruby
user_registration_complete_webhook_request = UserRegistrationCompleteWebhookRequest.new(

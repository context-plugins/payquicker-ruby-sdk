...
# Prepaid Card Pending Order Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`PrepaidCardPendingOrderWebhookRequest`
...
```ruby
prepaid_card_pending_order_webhook_request = PrepaidCardPendingOrderWebhookRequest.new(

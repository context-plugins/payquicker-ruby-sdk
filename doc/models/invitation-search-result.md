...
Paginated list of invitation objects with metadata and pagination links
...
|  --- | --- | --- | --- |
| `payload` | [`Array[InvitationObject]`](../../doc/models/invitation-object.md) | Required | **Constraints**: *Minimum Items*: `0`, *Unique Items Required* |
...
```ruby
invitation_search_result = InvitationSearchResult.new(
  payload: [
    InvitationObject.new(

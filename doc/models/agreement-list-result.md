...
Paginated list of agreement objects with metadata and pagination links
...
|  --- | --- | --- | --- |
| `payload` | [`Array[AgreementObject]`](../../doc/models/agreement-object.md) | Required | **Constraints**: *Minimum Items*: `0`, *Unique Items Required* |
...
```ruby
agreement_list_result = AgreementListResult.new(
  payload: [
    AgreementObject.new(

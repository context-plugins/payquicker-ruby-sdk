...
# Spendback Refund Created Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`SpendbackRefundCreatedWebhookRequest`
...
```ruby
spendback_refund_created_webhook_request = SpendbackRefundCreatedWebhookRequest.new(

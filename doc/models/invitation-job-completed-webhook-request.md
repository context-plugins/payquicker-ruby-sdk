...
# Invitation Job Completed Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`InvitationJobCompletedWebhookRequest`
...
```ruby
invitation_job_completed_webhook_request = InvitationJobCompletedWebhookRequest.new(

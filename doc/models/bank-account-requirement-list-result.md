...
Paginated list of bank account requirement objects with configuration details, fees, and field validators
...
|  --- | --- | --- | --- |
| `payload` | [`Array[BankAccountRequirement]`](../../doc/models/bank-account-requirement.md) | Required | - |
...
```ruby
bank_account_requirement_list_result = BankAccountRequirementListResult.new(
  payload: [

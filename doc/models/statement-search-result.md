...
Paginated list of statement objects with metadata and pagination links
...
|  --- | --- | --- | --- |
| `payload` | [`Array[StatementListObject]`](../../doc/models/statement-list-object.md) | Required | **Constraints**: *Minimum Items*: `0`, *Unique Items Required* |
...
```ruby
statement_search_result = StatementSearchResult.new(
  payload: [
    StatementListObject.new(

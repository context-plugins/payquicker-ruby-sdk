...
A [User](page:resources/users) record (a payee), returned with HATEOAS navigation links. Captures profile, addresses, contact, KYC status, and registration progress. See [User Status Types](page:additional-api-information/user-status-types) and [Users](page:resources/users).
...
user_object = UserObject.new(
  links: {
    'self' => NavigationLink.new(
      href: 'https://api.sandbox.payquicker.io/api/v2/users/user-19543ac9-83f9-4ef2-9964-71063789d0e1',
      method: 'GET',
      title: 'Self',

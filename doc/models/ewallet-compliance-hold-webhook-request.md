...
# Ewallet Compliance Hold Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`EwalletComplianceHoldWebhookRequest`
...
```ruby
ewallet_compliance_hold_webhook_request = EwalletComplianceHoldWebhookRequest.new(

...
A monthly [Statement](page:resources/statements) for a program account or user, returned with HATEOAS navigation links to download the rendered statement file. See [Statement Search Fields](page:additional-api-information/statement-search-fields).
...
```ruby
statement_object = StatementObject.new(

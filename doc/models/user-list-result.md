...
Paginated list of user objects with metadata and pagination links
...
|  --- | --- | --- | --- |
| `payload` | [`Array[UserObject]`](../../doc/models/user-object.md) | Required | List of user objects<br><br>**Constraints**: *Unique Items Required* |
...
```ruby
user_list_result = UserListResult.new(
  payload: [
    UserObject.new(
      links: {

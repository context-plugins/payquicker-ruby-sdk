...
# Transfer Quote Cancelled Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`TransferQuoteCancelledWebhookRequest`
...
```ruby
transfer_quote_cancelled_webhook_request = TransferQuoteCancelledWebhookRequest.new(

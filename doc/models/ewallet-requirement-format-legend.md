...
# Ewallet Requirement Format Legend

Human-readable legend describing the format of a required electronic-wallet field.

*This model accepts additional fields of type Object.*

## Structure

`EwalletRequirementFormatLegend`
...
```ruby
ewallet_requirement_format_legend = EwalletRequirementFormatLegend.new(
  key: 'string',
  description: 'string',

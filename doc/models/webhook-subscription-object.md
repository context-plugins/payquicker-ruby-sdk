...
`WebhookSubscriptionBase` returned with HATEOAS navigation links — the form returned in API responses. See [Webhook Subscriptions](page:resources/webhook-subscriptions).
...
```ruby
webhook_subscription_object = WebhookSubscriptionObject.new(

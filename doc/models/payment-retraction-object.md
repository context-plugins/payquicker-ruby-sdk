...
# Payment Retraction Object

A payment-retraction record (a payment reversed before completion), returned with HATEOAS navigation links. Created via [`POST /transfers`](page:resources/transfers) with `transferType: RETRACTION`. See [Transfers](page:resources/transfers).

*This model accepts additional fields of type Object.*

## Structure

`PaymentRetractionObject`
...
```ruby
payment_retraction_object = PaymentRetractionObject.new(

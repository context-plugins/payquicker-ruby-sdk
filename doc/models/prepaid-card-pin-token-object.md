...
`PrepaidCardPinTokenBase` returned with HATEOAS navigation links — the form returned in API responses. See [Sensitive Card Operations](page:resources/sensitive-card-operations).
...
```ruby
prepaid_card_pin_token_object = PrepaidCardPinTokenObject.new(
  ...
  links: {
    'self' => NavigationLink.new(
      href: 'https://api.sandbox.payquicker.io/api/v2/prepaid-cards/dest-ef104634-6c19-4f34-a1b1-9c92722d0c62/pin',
      method: 'GET',
      title: 'Self',

...
# Invitation Job Item Object

An invitation row returned from an [Invitation Job](page:resources/invitation-jobs)'s `/items` route, extending `InvitationJobItemBase` with HATEOAS navigation links. See [Invitation Jobs](page:resources/invitation-jobs).

*This model accepts additional fields of type Object.*

## Structure

`InvitationJobItemObject`
...
```ruby
invitation_job_item_object = InvitationJobItemObject.new(

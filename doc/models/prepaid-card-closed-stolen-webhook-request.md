...
# Prepaid Card Closed Stolen Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`PrepaidCardClosedStolenWebhookRequest`
...
```ruby
prepaid_card_closed_stolen_webhook_request = PrepaidCardClosedStolenWebhookRequest.new(

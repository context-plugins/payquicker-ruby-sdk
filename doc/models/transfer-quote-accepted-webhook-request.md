...
# Transfer Quote Accepted Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`TransferQuoteAcceptedWebhookRequest`
...
```ruby
transfer_quote_accepted_webhook_request = TransferQuoteAcceptedWebhookRequest.new(

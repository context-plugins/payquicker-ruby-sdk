...
# User Registration in Progress Webhook Request

*This model accepts additional fields of type Object.*

## Structure

`UserRegistrationInProgressWebhookRequest`
...
```ruby
user_registration_in_progress_webhook_request = UserRegistrationInProgressWebhookRequest.new(

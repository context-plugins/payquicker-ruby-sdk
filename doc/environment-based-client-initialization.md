...
SERVER_OAUTH_CLIENT_ID='oauthClientId'
SERVER_OAUTH_CLIENT_SECRET='oauthClientSecret'
SERVER_OAUTH_SCOPES=READ,WRITE
SERVER_OAUTH_CLOCK_SKEW=5
CLIENTSIDE_ACCESS_TOKEN='accessToken'
